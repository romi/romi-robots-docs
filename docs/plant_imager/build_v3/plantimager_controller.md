...
git clone --branch dev --recurse-submodules https://github.com/romi/plant-imager.git
```
...
### Install the sources
Then move to the cloned directory and install the `plant-imager` Python library and its submodules with:
```shell
